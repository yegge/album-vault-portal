...
export const TrackList = ({ albumId, onEdit }: TrackListProps) => {
  ...
  const handleDelete = async (trackId: string) => {
    ...
    try {
      const { error } = await supabase.from("tracks").delete().eq("track_id", trackId);
      ...
      logger.info("Track deleted", { action: "delete", trackId, albumId });
